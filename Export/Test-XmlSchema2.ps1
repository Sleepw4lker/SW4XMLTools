Function Test-XmlSchema2 {
    ...
    $XmlValidationHandler = [System.Xml.Schema.ValidationEventHandler] {
        ...
        Write-Warning -Message "Error found in $($Path) at Line $($_.Exception.LineNumber),$($_.Exception.LinePosition): $($_.Message)"
    ...
    $XmlReader = [System.Xml.XmlReader]::Create($XmlFile.FullName, $XmlReaderSettings)
